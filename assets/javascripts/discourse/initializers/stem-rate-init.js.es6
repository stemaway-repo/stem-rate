...
// $.ajax(document.location.origin + "/stem/rating/rate.json")
// 	$.ajax("/stem/rating/retract.json")

// $.ajax(document.location.origin + "/stem/rating/average.json",
// 	{
// 		data: {
// 			post_id: post.id
// 		},
    ...
    withPluginApi('0.8.6', api => {
			api.reopenWidget('post-menu', {
				like() {
					...
					if (!post.liked && post.post_number === 1) {
						showModal("stemRate", { post })
					}
				}
			})
		})
